...
export default class HciNode extends HarvesterResource {
  get _availableActions() {
    ...
    const enableCPUManager = {
      ...
      enabled: this.hasAction('enableCPUManager') && !this.isCPUManagerEnableInProgress && !this.isCPUManagerEnabled,
    ...
    const disableCPUManager = {
      ...
      enabled: this.hasAction('disableCPUManager') && !this.isCPUManagerEnableInProgress && this.isCPUManagerEnabled,
      icon:    'icon icon-fw icon-os-management',
