...
export default {
  ...
  methods: {
    ...
    showResourceDetails(value, workspace, selected) {
          ...
          >
            <div class="cards-panel-actions">
              <div class="cards-panel-filters">
                ...
                >
                  <template #label>
                    <i class="icon icon-lg icon-github mr-5" />
                ...
                >
                  <template #label>
                    <i class="icon icon-lg icon-linux mr-5" />
              ...
              <template v-if="cardResources[workspace.id][state.stateDisplay].length">
                ...
                >
                  <ResourceCard
                    ...
                    @click="showResourceDetails(item, workspace, `${ item.id }-${ y }`)"
                  />
                </div>
              </template>
            </div>
