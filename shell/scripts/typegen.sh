...
${BASE_DIR}/node_modules/.bin/tsc ${SHELL_DIR}/plugins/steve/index.js --declaration --allowJs --emitDeclarationOnly --outDir ${SHELL_DIR}/tmp/plugins/steve/index > /dev/null
